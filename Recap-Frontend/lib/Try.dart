...
class AppColors {
  ...
  static const bgGradTop = Color(0xFF0A1024);
  static const bgGradBottom = Color(0xFF050810);
  static const surface = Color(0xFF0E1320);
  static const surfaceAlt = Color(0xFF141A2A);
  static const surfaceHi = Color(0xFF1A2238);
  static const border = Color(0xFF1F2740);
  static const borderHi = Color(0xFF2A3656);
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [AppColors.bgGradTop, AppColors.bgGradBottom],
          ),
        ),
        child: Stack(
          children: [
            ...
            Positioned(
              top: -120,
              left: -80,
              child: _ambientGlow(AppColors.accent.withOpacity(0.18), 380),
            ),
            Positioned(
              top: 80,
              right: -120,
              child: _ambientGlow(AppColors.accent3.withOpacity(0.14), 420),
            ),
            SafeArea(
                        ...
                        children: [
                          ...
                          isWide
                              ? Row(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Expanded(flex: 7, child: _videoCard()),
                                    SizedBox(width: g),
                                    Expanded(flex: 7, child: _heatmapCard()),
                                  ],
                                )
                              : Column(
                                  children: [
                          ...
                          isWide
                              ? Row(
                                  ...
                                  children: [
                                    Expanded(flex: 7, child: _chartCard()),
                                    SizedBox(width: g),
                                    Expanded(flex: 5, child: _alertsCard()),
                                  ],
                                )
                              : Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
