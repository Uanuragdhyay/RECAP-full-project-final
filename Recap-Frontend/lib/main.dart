...
// =============================================================================
class AppColors {
  // Light SaaS background — soft mint/bluish gradient for a bright,
  // modern dashboard feel matching the reference design.
  static const bg = Color(0xFFF1F8F4);
  static const bgGradTop = Color(0xFFEFF8F3);    // soft mint
  static const bgGradMid = Color(0xFFEAF3FB);    // soft blue
  static const bgGradBottom = Color(0xFFF4FAF7); // pale mint-white
  ...
  static const borderHi = Color(0xFFCFDAE6);
  ...
  static const accent3 = Color(0xFF8B5CF6);
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              top: -160,
              left: -120,
              child: _ambientGlow(AppColors.accent.withOpacity(0.10), 520),
            ),
            Positioned(
              top: -60,
              right: -140,
              child: _ambientGlow(AppColors.accent3.withOpacity(0.08), 480),
            ),
            Positioned(
              bottom: -180,
              left: -100,
              child: _ambientGlow(AppColors.accent2.withOpacity(0.10), 540),
            ),
            Positioned(
              bottom: -120,
              right: -60,
              child: _ambientGlow(AppColors.success.withOpacity(0.08), 420),
            ),
